...
function TemplateCard({ template }: { template: JobTemplate }) {
  ...
  return (
    <Link
      href={`/jobs/new/misc?template=${template.id}`}
...
export default async function NewMiscJobPage({
  searchParams,
}: {
  ...
  if (templateId) {
    ...
    if (!template) redirect('/jobs/new/misc')
  ...
  return (
    <div className="max-w-lg mx-auto px-5 pt-12 pb-6">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold" style={{ color: '#E8E9ED' }}>Misc Job</h1>
